...
public class InterfacePreTriagem extends JFrame {
    ...
    public InterfacePreTriagem() {
        ...
        constraints.gridx = 0;
        constraints.gridy = 10; // Coloque a linha desejada para o botão
        ...
        constraints.gridx = 1;
        constraints.gridwidth = 1;
        painel.add(voltarButton, constraints);
        
        // Adicione um ActionListener para o botão "Voltar"
        voltarButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Voltar para a classe InterfacePrincipal
