...
public class InterfaceTriagem extends JFrame {
    ...
    public InterfaceTriagem() {
        ...
        // Inicialize os arrays de botões de rádio para as perguntas
        ...
        for (int i = 0; i < 15; i++) {
            ...
            switch (i) {
                ...
                case 3:
                    labelPergunta.setText("4. Você teve contato com pessoas que apresentaram sintomas de hepatite ou HIV nos últimos 6 meses?");
                    break;
            ...
            // Adicione os botões de rádio Sim e Não
        ...
        botaoVerificar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (elegivel) {
                    JOptionPane.showMessageDialog(null, "Você é elegível para doar sangue. Por favor, prossiga para a próxima etapa.");
                } else {
                    JOptionPane.showMessageDialog(null, "Você não é elegível para doar sangue. Por favor, consulte um profissional de saúde para obter mais informações e orientações.");
                }
            }
        });
        ...
        constraints.gridx = 0;
        constraints.gridy = 16; // Defina a posição do botão "Voltar"
        constraints.gridwidth = 3;
        constraints.fill = GridBagConstraints.NONE;
        constraints.anchor = GridBagConstraints.CENTER;
